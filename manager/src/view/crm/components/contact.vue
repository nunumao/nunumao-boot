<template>
  <div class="crm-components-customer">
    <el-input v-model="value.name" readonly :placeholder="placeholder" @click="open" />
    <el-dialog v-model="dialog" :title="placeholder" width="600px" destroy-on-close :before-close="close">
      <div>
        <div class="d-flex">
          <div>
            <el-input v-model="query.search" size="small" clearable placeholder="联系人姓名/联系人编号" />
          </div>
          <div class="ml-10">
        ...
        <div class="mt-10">
          <el-table :data="list.records" border>
            ...
            <el-table-column prop="company" label="所属客户" width="180" />
